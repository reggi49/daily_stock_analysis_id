...
"""
===================================
get_latest_data Tests
===================================

Responsibilities:
1. Verify get_latest_data method
2. Test returned data is sorted by date descending
3. Test days parameter limit
"""
...
class GetLatestDataTestCase(unittest.TestCase):
    ...
    def test_get_latest_data_ordered_by_date_desc(self) -> None:
        ...
        # Verify date descending (newest date first)
    ...
    def test_get_latest_data_filters_by_code(self) -> None:
        """Verify filtering by stock code"""
