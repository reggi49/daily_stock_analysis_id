...
class TestFetcherLogging(unittest.TestCase):
    def test_base_fetcher_logs_start_and_success(self):
        ...
        self.assertIn("[SuccessFetcher] Start getting 600519 Daily data", log_text)
        self.assertIn("[SuccessFetcher] 600519 get success:", log_text)
    ...
    def test_manager_logs_fallback_and_final_success(self):
        ...
        self.assertIn("[Data source try 1/2] [FailureFetcher] Get 601006...", log_text)
        self.assertIn("[Data source failed 1/2] [FailureFetcher] 601006:", log_text)
        self.assertIn("[Data source switching] 601006: [FailureFetcher] -> [SuccessFetcher]", log_text)
        self.assertIn("[Data source completed] 601006 Use [SuccessFetcher] get success:", log_text)
    ...
    def test_efinance_rejects_hk_daily_without_calling_eastmoney(self, mock_get_config):
        ...
        self.assertIn("Does not support Hong Kong stock daily line", str(captured.exception))
    ...
    def test_efinance_logs_eastmoney_endpoint_on_remote_disconnect(self):
        ...
        log_text = "\n".join(captured.output)
        self.assertIn("Eastmoney historyKLine interface failed:", log_text)
        ...
        self.assertIn("[EfinanceFetcher] 601006 Failed to obtain:", log_text)
