...
class TestAnalyzeRequest:
    ...
    def test_analyze_request_with_new_fields(self):
        ...
        assert request.original_query == "Moutai"
...
class TestTaskInfo:
    ...
    def test_task_info_with_new_fields(self):
        ...
        assert d["original_query"] == "Moutai"
    ...
    def test_task_info_copy_includes_new_fields(self):
        ...
        copied = task.copy()
        assert copied.original_query == "Moutai"
...
class TestTaskQueue:
    ...
    def test_task_queue_accepts_new_fields(self):
        ...
        assert tasks[0].original_query == "Moutai"
    ...
    def test_task_queue_batch_with_new_fields(self):
        ...
        assert len(tasks) == 2
        for task in tasks:
            assert task.stock_name == "bulk stock"
...
class TestIntegration:
    ...
    def test_end_to_end_flow_with_autocomplete(self):
        ...
        assert task.original_query == "Moutai"
