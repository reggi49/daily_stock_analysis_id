...
Traditional Chinese | [English](README_EN.md) | [Simplified Chinese](../README.md)
...
<div align="center">
  <p align="center">
    ...
    <a href="https://serpapi.com/baidu-search-api?utm_source=github_daily_stock_analysis" target="_blank"><img src="assets/serpapi_banner_zh.png" alt="Easily scrape real-time financial news data from search engines - SerpApi" width="300" height="141" style="width: 300px; height: 141px; object-fit: contain;"></a>
  </p>
</div>
...
> Detailed fields, fundamental P0 timeout semantics, trading rules, data-source priority, Web/API behavior, and troubleshooting live in the [Full Configuration & Deployment Guide](./full-guide.md).
...
> The project includes free market-data sources such as AkShare, Baostock, and YFinance and can run without extra data-source credentials. These free sources can be rate-limited, change upstream contracts, or fluctuate by network condition, so stability is not guaranteed. For scheduled runs, batch analysis, or steadier quotes, configure token-based sources such as TickFlow, Tushare, or Longbridge; market coverage, Actions mappings, and fallback rules are documented in [Data Source Configuration](./full-guide.md#data-source-configuration).
...
| Secret Name | Description | Required |
|-------------|------|:----:|
| `STOCK_LIST` | Watchlist codes, such as `600519,hk00700,AAPL,7203.T,005930.KS,2330.TW` | Required |
...
### Option 2: [Client Setup Tutorial](https://www.bilibili.com/video/BV11FEb66Eyr/) / Local / Docker Deployment
...
> Docker deployment, scheduling, and cloud-server WebUI access are documented in the [Full Guide](./full-guide.md); desktop client packaging is documented in [Desktop Packaging Guide](./desktop-package.md).
...
Risk Alerts:
Risk 1: Main-force funds showed notable outflow; watch for short-term selling pressure.
Risk 2: Chip concentration suggests potential resistance on upward moves.

Positive Catalysts:
Catalyst 1: Company positioned as a core AI supply-chain target by the market.
Catalyst 2: Recent earnings growth provides fundamental support for the share price.
```

### Market Review

```markdown
Market Review 2026-01-10
...
Full environment variables, model routing, notification channels, data-source priority, trading rules, fundamental P0 semantics, and deployment details are in the [Full Configuration Guide](./full-guide.md).
...
<table>
  ...
  <tr>
    ...
    <td valign="top"><a href="https://github.com/ZhuLinsen/daily_stock_analysis/issues">GitHub Issues</a></td>
  </tr>
</table>
