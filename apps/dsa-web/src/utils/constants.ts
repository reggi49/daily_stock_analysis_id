...
// Keep same-origin API by default to avoid routing requests to localhost in production/static deployments.
// Only override the default when VITE_API_URL is explicitly provided.
