...
const normalizeBoardType = (value?: string): 'sector' | 'concept' | null => {
  ...
  if (['industry', 'sector'].includes(normalized)) {
    return 'sector';
  }
  if (['theme', 'concept'].includes(normalized)) {
    return 'concept';
  }
  return null;
};
...
/**
 * Report overview panel - terminal style
 */
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 items-start">
        ...
        {/* Right: sentiment gauge / watchlist */}
