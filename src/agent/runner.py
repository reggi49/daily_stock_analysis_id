...
_THINKING_TOOL_LABELS: Dict[str, str] = {
    "get_realtime_quote": "Market Data Fetch",
    "get_daily_history": "Candlestick Data Fetch",
    ...
    "get_stock_backtest_summary": "Individual Stock Backtest Data",
}
    ...
    *,
    ...
    for step in range(max_steps):
        ...
        if response.tool_calls:
            ...
            if progress_callback:
                progress_callback(stream_event("generating", step=step + 1, message="Generating final analysis..."))
