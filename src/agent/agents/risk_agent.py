...
2. **Earnings Warnings** — pre-loss, downward revisions (Pre-performance loss, Performance changes)
3. **Regulatory** — penalties, investigations, violations (regulatory penalties, File an investigation)
4. **Industry Policy** — headwinds, sector crackdowns
5. **Lock-up Expirations** — large block unlocks within 30 days (Lift the ban)
