...
def _find_column(df: pd.DataFrame, canonical: str) -> Optional[Any]:
    candidates = {
        "date": ("date", "trade_date", "datetime", "time", "Date", "transaction date"),
        "open": ("open", "open_price", "Open", "opening price"),
        "high": ("high", "high_price", "highest", "highest price"),
        "low": ("low", "low_price", "lowest", "lowest price"),
        "close": ("close", "close_price", "close", "closing price"),
